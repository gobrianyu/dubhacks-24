...
class SocialsState extends State<Socials> {
  ...
  void initFeed() {
    ...
    feed.add(DreamPost(username: 'kcheebe', time: DateTime.parse('2024-10-13 06:35:00Z'), profilePic: 'assets/images/samplepfp.png', caption: 'Hey everyone I just had the craziest dream last night. I was walking through a lush green meadow filled with adorable llamas. They were all so fluffy and friendly, and I couldn\'t help but feel a deep connection to them. I know it sounds silly, but it really left an impression on me. Anyone else ever have dreams that feel so real? #LlamaDreams #DreamsThatFeelReal', imageLink: 'assets/images/7.png'));
    feed.add(DreamPost(username: 'tamsynnn', time: DateTime.parse('2024-10-12 06:00:00Z'), profilePic: 'assets/images/default.png', caption: 'Just had the craziest dream I was at the zoo, and all the animals could talk. The monkeys were chatting about their favorite fruits, while the lions were discussing the latest savannah gossip. Even the penguins were sharing jokes. #TalkingAnimals #ZooDreams #WildNightmares', imageLink: 'assets/images/8.png'));
    feed.add(DreamPost(username: 'canard23', time: DateTime.parse('2024-10-12 06:00:00Z'), profilePic: 'assets/images/samplepfp2.png', caption: 'I had a pretty vivid dream last night. In it, I was standing in a lush green meadow filled with llamas. Suddenly, one of the llamas started running frantically and fell into a deep hole that seemed to appear out of nowhere. The other llamas were startled and began to panic, trying to help their fallen friend. The scene was quite surreal and left me feeling a bit uneasy when I woke up. I\'m not sure what it could mean, but it\'s definitely stuck with me.', imageLink: 'assets/images/9.png'));
    feed.add(DreamPost(username: 'nano.d3m2', time: DateTime.parse('2024-10-11 06:00:00Z'), profilePic: 'assets/images/kiko.jpg', caption: 'I dreamt about being a detective in one of those old detective films, solving crimes and murders. Don\'t ask why I have two accounts...', imageLink: 'assets/images/sample_post_picture_1.png'));
    feed.add(DreamPost(username: 'rando', time: DateTime.parse('2024-10-10 06:00:00Z'), profilePic: 'assets/images/sheeppuff.png', caption: 'RAHHHH CANDIES IN THE SKY I LOVE MY DREAMS #BEST #DREAM #EVER', imageLink: 'assets/images/sample_post_picture_2.png'));
    feed.add(DreamPost(username: 'i.mallard', time: DateTime.parse('2024-10-08 06:00:00Z'), profilePic: 'assets/images/anglefin.png', caption: 'Why was I dreaming of books lol 😭', imageLink: 'assets/images/sample_post_picture_3.png'));
  }
}
