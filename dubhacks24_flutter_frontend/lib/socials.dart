...
class SocialsState extends State<Socials> {
  ...
  void initFeed() {
    ...
    feed.add(DreamPost(username: 'i.mallard', time: DateTime.now(), profilePic: 'assets/images/pic.jpg', caption: 'Why was I dreaming of books lol', imageLink: 'assets/images/sample_post_picture_3.png'));
  }
}
