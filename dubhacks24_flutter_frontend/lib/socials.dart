...
class SocialsState extends State<Socials> {
  ...
  void initFeed() {
    ...
    feed.add(DreamPost(username: 'rando', time: DateTime.parse('2024-10-10 06:00:00Z'), profilePic: 'assets/images/default.png', caption: 'RAHHHH CANDIES IN THE SKY I LOVE MY DREAMS #BEST #DREAM #EVER', imageLink: 'assets/images/sample_post_picture_2.png'));
    feed.add(DreamPost(username: 'i.mallard', time: DateTime.parse('2024-10-08 06:00:00Z'), profilePic: 'assets/images/default.png', caption: 'Why was I dreaming of books lol 😭', imageLink: 'assets/images/sample_post_picture_3.png'));
  }
}
