...
List<DreamPost> _demoPosts(String username) {
  ...
  posts.add(DreamPost(username: username, imageLink: 'assets/images/1.png', time: DateTime.parse('2024-09-20 06:18:00Z'), profilePic: '', caption: 'In the heart of the dreamy library, books floated gracefully, their spines glowing with whispered histories. As I reached for one, a shimmering light enveloped me, and suddenly, I was in a sunlit village where my ancestors thrived. I felt their laughter echoing through the fields, tasted the salt of their tears during storms. Each joy was mine, each struggle a shared heartbeat. I danced at their weddings, stood firm during their losses, weaving my spirit into the tapestry of their lives. Just as I began to grasp their resilience, the book closed, and I was back in the library, forever changed, connected through time.'));
